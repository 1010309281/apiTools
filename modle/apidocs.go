...
func GetAllApiInfo() (allApiInfo *AllApiInfo, err error) {
	...
	for key, value := range jsonData {
		...
		apiInfo.RequestCount = getApiReqCount(fmt.Sprintf("%v", apiJson["countKey"]), redisClient)
...
// 获取指定api文档的信息
func GetApiDocInfo(apiFileName string, urlPath string, countKey string) (apiDocInfo *ApiDocInfo, err error) {
	// 初始化返回数据结构
